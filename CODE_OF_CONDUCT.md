...
fetched 2026-08-24. Two things are changed from the upstream text and both are marked where they
appear: the reporting channel, and an honest description of who receives a report. Everything else
is upstream wording.

The licence on this file is **not** the repository's. See *Licence* at the bottom, and `NOTICE`.
...
>   to inside this project. If that makes reporting here useless to you, GitHub accepts reports
>   about a user's conduct independently of any repository, and that route does not run through
>   this project at all.
> - **Acknowledgement within a week**, on the same terms `SECURITY.md` sets for vulnerability
>   reports: a real limit rather than a promise dressed up as one. If a week passes with silence,
>   send a reminder.
>
> This paragraph replaces a sentence that would have described a moderation team this project does
> not have. A documented channel with nobody behind it is the `N-06` failure the rest of this
> repository exists to avoid, and a code of conduct is a worse place to make it than a metadata
> document.

Reports are taken seriously and will be responded to as promptly as possible. Reports are
investigated by reviewing messages, logs, and recordings, or by talking to witnesses and other
participants. Investigation and enforcement are kept as transparent as possible while prioritizing
safety and confidentiality: enforcement actions are carried out in private with the involved
parties, and communicating to the whole community may be part of a mutually agreed resolution.
...
3. **Temporary suspension**
   - *Event:* A pattern of repeated violation which warnings have failed to address, or a single
     serious violation.
...
4. **Permanent ban**
   - *Event:* A pattern of repeated code of conduct violations that other steps on the ladder have
     failed to resolve, or a violation so serious that there is no way to keep the community safe
...
This enforcement ladder is intended as a guideline. It does not limit the use of discretion and
judgment in keeping with the best interests of the community.
...
argues about design in the open, and `CONTRIBUTING.md` will tell you a pull request without a stated
measurement is not reviewable. Firm technical disagreement, a rejected patch, and a review that asks
you to justify a decision are none of them violations of this document.

## Licence

This file is adapted from the Contributor Covenant, version 3.0, permanently available at
...
Translations are at <https://www.contributor-covenant.org/translations>. The enforcement ladder was
