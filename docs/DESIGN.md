...
| **A CIMD client is not an entity** | `A-08` requires 100 sequential CIMD connects to leave the client table unchanged. "Just cache it in the clients table" is the obvious move and it breaks the property the product is sold on |
