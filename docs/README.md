...
| [`decisions/mcp-per-tool-authorization-2026-08.md`](decisions/mcp-per-tool-authorization-2026-08.md) | Anyone gating an individual MCP tool on a scope, or about to hand-roll a step-up challenge inside a connector | Nothing. §1 is an unmeasured question that blocks one of its four items on purpose, and §3 is the boundary that outlives all of them | decision record |
